...
DO_qtl_scan = scan1(apr, cross_basic$pheno[,c(5:79,81,83,85)], k_loco, Xcovar=Xcovar, addcovar = covar[,c("sex", "age_at_sac_days","body_weight","generationG24","generationG25","generationG26","generationG27","generationG28","generationG29","generationG30","generationG31","generationG32","generationG33","generationG34","generationG35")],cores = 2)
#save(DO_qtl_scan,file = "./results/Rdata/DO_qtl_scan.Rdata")

#scan MAT as binary traits
DO_qtl_scan_binary = scan1(apr, cross_basic$pheno[,c(80,82,84,86)], Xcovar=Xcovar, addcovar = covar[,c("sex", "age_at_sac_days","body_weight","generationG24","generationG25","generationG26","generationG27","generationG28","generationG29","generationG30","generationG31","generationG32","generationG33","generationG34","generationG35")],cores = 2)
...
DO_qtl_scan_normal = scan1(apr, pheno_combined, k_loco, Xcovar=Xcovar, addcovar = new_covar[,c("sex", "age_at_sac_days","body_weight","generationG24","generationG25","generationG26","generationG27","generationG28","generationG29","generationG30","generationG31","generationG32","generationG33","generationG34","generationG35")],cores = 4)
...
DO_qtl_scan_binary_norm = scan1(apr, cross_basic$pheno[,c(80,82,84,86)], Xcovar=Xcovar, addcovar = new_covar[,c("sex", "age_at_sac_days","body_weight","generationG24","generationG25","generationG26","generationG27","generationG28","generationG29","generationG30","generationG31","generationG32","generationG33")],cores = 2)
