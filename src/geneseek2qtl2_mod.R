...
codefile <- "./data/GIGAMUGA/GM_processed_files/GM/GM_allelecodes.csv"
...
ifiles <- c("./data/GIGAMUGA/FinalReport_files/Univ_of_Virginia_Al-Barghouthi_MURGIGV01_20171110_FinalReport.txt",
            ...
            "./data/GIGAMUGA/FinalReport_files/Univ_of_Virginia_Al-Harghouthi_MURGIGV01_20200106_FinalReport.txt",
            "./data/GIGAMUGA/FinalReport_files/20200305_FinalReport_FIXED.txt")

# file "stem" for output files
# output files will be like "DO_qtl2_geno19.csv"
ostem <- "./results/GIGAMUGA/qtl2_all/DO_qtl2"
